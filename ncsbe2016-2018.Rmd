...
Overall, voter registration in the state grew by `r as.character(sums_table[4,4])`.  However, the number of Democratic voters changed by `r as.character(sums_table[4,1])`.  Meanwhile, the number of Republican voters saw a smaller change of `r as.character(sums_table[4,2])` in regsitered voters. The remainder of this analysis looks at changes in party affiliation at the county level in North Carolina.
```{r, message=F, warning=F, comment=F}
